...
function calcularBalancim1() {
  ...
  document.getElementById('gcorpoinex').innerHTML = balancim1 + " Par de G. Corpo 1m";
...
document.getElementById('clipes').innerHTML = balancim1*12 + " Clipes";
...
function calcularBalancim1M() {
  ...
  document.getElementById('gcorpoinex1m').innerHTML = balancim1m + " Par de G. Corpo 1,5m";
...
document.getElementById('clipes1m').innerHTML = balancim1m*12 + " Clipes";
...
function calcularBalancim2M() {
  ...
  document.getElementById('gcorpoinex2M').innerHTML = balancim2 + " Par de G. Corpo 2m";
...
document.getElementById('clipes2M').innerHTML = balancim2*12 + " Clipes";
...
function calcularBalancim3() {
  ...
  document.getElementById('gcorpoinex3').innerHTML = `${balancim3} Par de G. Corpo 3m`;
...
document.getElementById('clipes3').innerHTML = balancim3*12 + " Clipes";
...
function calcularBalancim4() {
  ...
  document.getElementById('gcorpoinex4').innerHTML = `${balancim4*2} Pares de G. Corpo 2m`;
...
document.getElementById('clipes4').innerHTML = balancim4*12 + " Clipes";
...
function calcularBalancim5() {
  ...
  document.getElementById('gcorpoinex5').innerHTML = `${balancim5} Par de G. Corpo de 2m e de 3m`;
...
document.getElementById('clipes5').innerHTML = balancim5*12 + " Clipes";
...
function calcularBalancim6() {
  ...
  document.getElementById('gcorpoinex6').innerHTML = `${balancim6*2} Pares de G. Corpo de 3m`;
...
document.getElementById('clipes6').innerHTML = balancim6*12 + " Clipes";
